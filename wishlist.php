...
<head>
    ...
    <title>Wishlist - K❤️sMarket</title>
    <meta name="description" content="Daftar barang favorit Anda">
...
<body>
        ...
        <div class="container">
            ...
            <div class="search-box">
                <form action="products.php" method="GET" class="search-form">
                    ...
                    <input type="text" name="search" placeholder="Cari barang preloved..." autocomplete="off" id="search-input">
    ...
    <main class="container" style="margin-top: 2rem;">
        ...
        <div class="d-flex justify-between align-center mb-4">
            <div>
                <h1><span class="icon">❤️</span> Wishlist Saya</h1>
                <p class="text-muted">Daftar barang favorit Anda (<?= count($wishlist_items) ?> item)</p>
            </div>
        </div>
        ...
        <div class="product-grid">
            <?php if (empty($wishlist_items)): ?>
                <div class="empty-state">
                    ...
                    <p>Mulai tambahkan barang favorit Anda ke wishlist</p>
                ...
                <?php foreach ($wishlist_items as $item): ?>
                    <div class="card">
                        <div style="position: relative;">
                            ...
                            <button class="wishlist-btn active" data-product-id="<?= $item['id_produk'] ?>" onclick="toggleWishlist(<?= $item['id_produk'] ?>)">
